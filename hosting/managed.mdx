...
## **Administration Panel: CloudPanel**
...
## Can I have cPanel or other panel instead?

No, for our managed hosting we exclusively offer CloudPanel. On the more advanced hosting packages, if you own a license, you're free to install whatever control panel you think is suitable for you, however after extensive research, we've came with the conclusion that CloudPanel fits most of our managed hosting users and does it really effectively.